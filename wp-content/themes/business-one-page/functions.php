...
function business_one_page_scripts() {
	...
	if( get_theme_mod( 'ed_localgoogle_fonts',false ) && ! is_customize_preview() && ! is_admin() ){
        if ( get_theme_mod( 'ed_preload_local_fonts',false ) ) {
			business_one_page_load_preload_local_fonts( business_one_page_get_webfont_url( business_one_page_fonts_url() ) );
        }
        wp_enqueue_style( 'business-one-page-google-fonts', business_one_page_get_webfont_url( business_one_page_fonts_url() ) );
    }else{
...
function business_one_page_customize_scripts() {
	...
	wp_localize_script( 'business-one-page-customize-js', 'business_one_page_cdata', $array );
}
endif;
