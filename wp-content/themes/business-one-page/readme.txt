...
Business One Page bundles the following third-party resources:
    ...
    * Webfonts Loader
        Business One Page local fonts feature is based on Webfonts Loader by WordPress Themes Team (WPTT). (https://github.com/WPTT/webfont-loader)
        License: MIT
...
== Changelog ==
    ...
    1.2.9 - 20-06-2023
    * Updated: Relevant tags for the theme has been added.
